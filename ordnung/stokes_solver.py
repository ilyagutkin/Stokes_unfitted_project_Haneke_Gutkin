...
def P1_P0(mesh, levelset, order=None, f=CF((0,0)), ud=CF((0,0)), nu=1, uexact=None, pexact=None):
    gamma_stab = 100
    beta0 =1
    beta1 = 1
    beta2 = 1
...
def Divergence_free(mesh, levelset, order=2, f=CF((0,0)), ud=CF((0,0)), nu=1, uexact=None, pexact=None):
